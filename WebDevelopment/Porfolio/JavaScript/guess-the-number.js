...
function play(){
    ...
    if (isNaN(user_guess) || user_guess == ''){
        ...
        if (user_guess < answer){
            ...
            mesg2.textContent = "You have had " + no_of_guess + " guesses";
            mesg3.textContent = "Please guess again";
            ...
            document.getElementById("guess-footer").style.background = "green";
...
function lowerOrHigher(input, num){
    if (Math.abs(input - num) <= 10){
        document.getElementById("guess-footer").style.background = "red";
        document.getElementById("guess-footer").style.color = "white";
    }
    else if (Math.abs(input - num) >= 30){
        document.getElementById("guess-footer").style.background = "blue";
        document.getElementById("guess-footer").style.color = "white";
    }
    else{
        document.getElementById("guess-footer").style.background = "white";
        document.getElementById("guess-footer").style.color = "black";
    }
}
